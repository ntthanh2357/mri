...
# Import hàm tiền xử lý (giữ nguyên quy trình xử lý dữ liệu giống ResNet để đảm bảo công bằng khi benchmark)
...
# ============================================================
# 2. Load dữ liệu (Sử dụng chung hàm load của dự án)
# ============================================================
...
# ============================================================
# 3. Xây dựng mô hình EfficientNetV2
# ============================================================
print("\nKhởi tạo mô hình EfficientNetV2B0...")
base_model = EfficientNetV2B0(weights='imagenet', include_top=False, input_shape=(224, 224, 3))
base_model.trainable = False  # Giai đoạn 1: Đóng băng base model
...
# 4. Huấn luyện
# ============================================================
best_model_path = os.path.join(SAVE_DIR, 'best_efficientnet_model.keras')
...
print("\n[STAGE 1] Huấn luyện Classification Head (EfficientNet đóng băng)...")
history1 = model.fit(train_dataset, epochs=10, validation_data=val_dataset, class_weight=class_weight_dict)

print("\n[STAGE 2] Fine-tuning (Mở khóa 30 layers cuối của EfficientNet)...")
...
# ============================================================
print("\n--- BÁO CÁO ĐÁNH GIÁ EFFICIENTNETV2 TRÊN TẬP TEST ---")
