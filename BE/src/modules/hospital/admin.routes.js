...
router.post("/hospitals/:id/setup-drive", requireSystemAdmin, repairHospitalDrive);
...
router.get("/hospitals/:id/backup/download/:fileName", requireSystemAdmin, downloadHospitalBackup);
