...
export default StyleSheet.create({
  ...
  retryBtn: { backgroundColor: '#0891B2', borderRadius: 10, paddingHorizontal: 20, paddingVertical: 10 },
  ...
  identityEditHint: { fontSize: 10, color: '#38BDF8', marginTop: 4 },
  searchContainer: {
  ...
  dotOutpatient: { backgroundColor: '#0891B2' },
  ...
  visitDocCount: { fontSize: 16, fontWeight: 'bold', color: '#0891B2' },
  ...
  progressText: { fontSize: 11, color: '#0891B2', fontWeight: '600', minWidth: 60 },
  ...
  docCardHas: { backgroundColor: '#F0FDFA', borderColor: '#A5F3FC' },
  ...
  docStatusHas: { fontSize: 10, color: '#0891B2', marginTop: 2 },
  docStatusMissing: { fontSize: 10, color: '#94A3B8', marginTop: 2 },
  countBadge: {
    minWidth: 20, height: 20, borderRadius: 10, backgroundColor: '#0891B2',
